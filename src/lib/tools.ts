...
export const tools: Tool[] = [
  // Documents
  { slug: "merge-pdf", name: "Merge PDF", description: "Combine PDFs in the order you want.", icon: Combine, category: "documents", tint: "rust", implemented: true, acceptsFileType: "application/pdf" },
  { slug: "split-pdf", name: "Split PDF", description: "Pull pages out of a PDF into new files.", icon: Scissors, category: "documents", tint: "rust", implemented: true },
  { slug: "compress-pdf", name: "Compress PDF", description: "Reduce file size while keeping quality.", icon: Minimize2, category: "documents", tint: "rust", implemented: true },
  { slug: "pdf-to-image", name: "PDF → Image", description: "Convert each page to JPG or PNG.", icon: FileImage, category: "documents", tint: "rust", implemented: true },
  ...
  { slug: "remove-background", name: "Remove background", description: "Clean cutouts using on-device AI.", icon: Eraser, category: "images", tint: "moss", implemented: true },
  { slug: "image-palette", name: "Extract palette", description: "Pull dominant colors from any image.", icon: Palette, category: "images", tint: "moss", implemented: true },
  ...
  { slug: "summarizer", name: "Summarizer", description: "Condense long passages to key points.", icon: Sparkles, category: "text", tint: "clay", implemented: true },
  ...
  { slug: "zip-files", name: "Zip files", description: "Bundle a folder into a single archive.", icon: Archive, category: "files", tint: "ink", implemented: true },
  { slug: "unzip", name: "Unzip", description: "Extract files from any .zip archive.", icon: FileArchive, category: "files", tint: "ink", implemented: true },
