...
export function AiSummarizer() {
  ...
  const handleSummarize = async () => {
    ...
    try {
            ...
            messages: [
              {
                role: "system",
                content:
                  "You are a concise summarizer. Extract the most important points from the text provided. Use bullet points if appropriate. Focus on clarity and brevity.",
              },
              {
                role: "user",
                content: input,
      ...
      toast.error(
        error.message ||
          "Something went wrong. Check your API key or connection.",
      );
    } finally {
      setLoading(false);
    }
