...
import { PrimaryButton, ToolPanel, GhostButton, CopyButton, FieldLabel } from "./shared";
            ...
            {summary && (
                <ToolPanel className="border-accent/20 bg-accent/5">
                    <div className="flex items-center justify-between mb-2">
                        <h3 className="text-xs font-semibold uppercase tracking-wider text-accent">Summary</h3>
