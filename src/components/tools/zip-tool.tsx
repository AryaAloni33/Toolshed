                    ...
                    >
                        {files.length === 0 ? (
                            <div className="text-center">
                                ...
                                <div className="text-sm font-medium">Drop files here to zip them</div>
                                <input
                                    type="file"
                                    multiple
                            ...
                            <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                                {files.map((file, i) => (
                                    <div key={i} className="flex items-center gap-2 rounded-md border border-border bg-card p-2 text-xs">
                    ...
                    {files.length > 0 && (
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-end">
                            <div className="flex-1">
                                <label className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">Archive Name</label>
                                <input
                                    type="text"
                                    value={zipName}
                            ...
                            <PrimaryButton onClick={createZip} disabled={processing} className="sm:w-40">
