            ...
            const response = await fetch("https://api.groq.com/openai/v1/chat/completions", {
                ...
                body: JSON.stringify({
                    ...
                    messages: [
                        {
                            role: "system",
                            content: "You are a data extraction assistant. Extract key entities, dates, URLs, and main themes from the provided text. Return the result in a clean, structured format (using markdown headers and bullets).",
                        },
                        {
                            role: "user",
                            content: input,
